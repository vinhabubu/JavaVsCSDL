...
public class InsertUI extends JFrame {
	...
	private void addControl() {
		...
		JLabel lblTitleAdd = new JLabel("Thêm thông tin tài sản");
	...
	protected void xuLyLuu() {
		...
		try {
			...
			statement.setString(3, txtNgayNhap.getText());
			statement.setInt(4, Integer.parseInt(txtSoNamKhauHao.getText()));
			statement.setInt(5, Integer.parseInt(txtGiaTri.getText()));
			
			int x = statement.executeUpdate();
			if(x>0) {
				JOptionPane.showMessageDialog(null, "Lưu tài sản mới thành công");
